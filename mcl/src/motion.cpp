...
static const double VEL_LIN_N1 = 0.0005;  // Linear velocity noise coefficient 1
static const double VEL_LIN_N2 = 0.0005;  // Linear velocity noise coefficient 2
...
static const double TH_N1 = 0.0005;      // Final rotation noise coefficient 1
static const double TH_N2 = 0.0005;      // Final rotation noise coefficient 2
