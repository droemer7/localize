...
static const double VEL_LIN_N1 = 0.002;         // Linear velocity noise coefficient 1
static const double VEL_LIN_N2 = 0.002;         // Linear velocity noise coefficient 2
static const double VEL_ANG_N1 = 0.002;         // Angular velocity noise coefficient 1
static const double VEL_ANG_N2 = 0.002;         // Angular velocity noise coefficient 2
static const double TH_N1 = 0.002;              // Final rotation noise coefficient 1
static const double TH_N2 = 0.002;              // Final rotation noise coefficient 2
static const double VEL_ANG_BIAS_SCALE = 0.01;  // Decreases angular velocity in relation to scale * linear velocity^2 / radius
