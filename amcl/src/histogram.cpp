...
static const double HIST_OCCUPANCY_XY_RES = 0.20;         // Occupancy histogram resolution for x and y position (meters per cell)
static const double HIST_OCCUPANCY_TH_RES = L_PI / 90.0;  // Occupancy histogram resolution for heading angle (rad per cell)
